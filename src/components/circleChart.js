...
export default function CircleC(props) {
  ...
  const data = [
    ...
    },
    {
      name: "user",
      value:
        props.userData.score == undefined
          ? props.userData.todayScore
    ...
    <ResponsiveContainer className="circleChartContainer">
      ...
      >
        ...
        <text
          ...
          className="progress-label percentage"
        >
          {props.userData.score == undefined
            ? props.userData.todayScore * 100
            : props.userData.score * 100}
          %
        </text>
        <text
          fill="#74798C"
        ...
        <text
          ...
          textAnchor="middle"
          dominantBaseline="middle"
          className="progress-label score"
        >
          Score
        </text>
